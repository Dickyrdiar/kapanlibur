      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div className="hidden sm:mb-8 sm:flex sm:justify-center">
          <div
            className={`relative rounded-full px-3 py-1 text-sm leading-6 ${
              theme === "dark"
                ? "text-gray-300 ring-gray-700 hover:ring-gray-600"
        ...
        <div className="text-center">
          ...
          {loading ? (
            ...
            <>
              <h1
                className={`text-2xl w-[100%] font-bold tracking-tight ${
              ...
              >
                <span>{days} {t("day")},</span> <span>{hours} {t("hour")},</span>{" "}
      ...
      >
        <div
          className={`relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 ${
            theme === "dark"
              ? "bg-gradient-to-tr from-[#4a5568] to-[#2d3748]"
              : "bg-gradient-to-tr from-[#7b4079] to-[#5a54ae]"
